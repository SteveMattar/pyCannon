...
class Vector2(object):
    ...
    def set_by_values(self, x, y):

        # set this vector to x y passed in
        self.x = float(x)
        self.y = float(y)

    def set_by_angle(self, angle_degrees):
    ...
    def angle_between_degrees180(self, other):
